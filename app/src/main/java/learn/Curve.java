...
public class Curve {
    ...
    private learn.Point G;            //the generator point, a point on the elliptic curve chosen for cryptographic operations
    private BigInteger n;       //Order of Point G
    private String mode;        //The defined mode of curve
    public ArrayList<learn.Point> ellipticGroup;      //Group contains all points over elliptic curve
    ...
    public Curve(String mode) {
        ...
        switch(mode){
            case "P-256": // E : y2 = x3 - 3x + b (mod p)
                ...
                G = new learn.Point(new BigInteger("6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296", 16),
            ...
            case "P-192": // E : y2 = x3 - 3x + b (mod p)
                ...
                G = new learn.Point(new BigInteger("188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012", 16),
            ...
            case "P-224": // E : y2 = x3 - 3x + b (mod p)
                ...
                G = new learn.Point(new BigInteger("b70e0cbd6bb4bf7f321390b94a03c1d356c21122343280d6115c1d21", 16),
            ...
            case "P-384": // E : y2 = x3 - 3x + b (mod p)
                ...
                G = new learn.Point(new BigInteger("b3312fa7e23ee7e4988e056be3f82d19181d9c6efe8141120314088f5013875ac656398d8a2ed19d2a85c8edd3ec2aef", 16),
            ...
            case "P-521": // E : y2 = x3 - 3x + b (mod p)
                ...
                G = new learn.Point(new BigInteger("c6858e06b70404e9cd9e3ecb662395b4429c648139053fb521f828af606b4d3dbaa14b5e77efe75928fe1dc127a2ffa8de3348b3c1856a429bf97e7e31c2e5bd66", 16),
        ...
        while (x.compareTo(this.p.subtract(BigInteger.ONE)) <= 0){
            ...
            for (BigInteger j = BigInteger.ONE; j.compareTo(this.p.subtract(BigInteger.ONE)) <= 0; j = j.add(BigInteger.ONE)){
                ...
                if (isPerfectSquare(y3)) {
                    y = sqrt(y3);
                    learn.Point po = new learn.Point(x,y,a,p);
                    if (!isPointInGroup(po)){
                        ellipticGroup.add(po);
                        n = n.add(BigInteger.ONE);
                    }
                    learn.Point pp = new learn.Point(x, this.p.subtract(y), a, p);
    ...
    private boolean isPointInGroup(learn.Point p){
        boolean found = false;
        int i = 0;
